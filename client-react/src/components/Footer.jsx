      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
        <div>
          ...
          <p className="text-gray-400 mb-4">
            HomeService Pro connects homeowners with trusted, licensed professionals for all home service needs since 2015.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-gray-400">123 Service Lane, Suite 100<br />New York, NY 10001</p>
          <p className="text-gray-400 mt-2">Phone: (555) 123-4567</p>
          <p className="text-gray-400">Email: info@homeservicepro.com</p>
        </div>
      </div>
      <div className="text-center text-gray-500 text-xs mt-10">
        © 2025 HomeService Pro. All rights reserved. | <a href="#" className="underline">Privacy Policy</a> | <a href="#" className="underline">Terms of Service</a>
      </div>
    </footer>
  );
};
